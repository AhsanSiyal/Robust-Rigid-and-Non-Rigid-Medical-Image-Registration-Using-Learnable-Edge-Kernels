from arch.Reg_LEdge_U_Model_Variant_1 import ResUnet as ResNet
...
def main():
    ...
    save_dir = 'NR_ID_2_1_ncc_{}_diffusion_{}/'.format(weights[0], weights[1])
    ...
    torch.save(model.state_dict(), 'experiments/NR_ID_2_1_ep500_sm3.pth.tar')
