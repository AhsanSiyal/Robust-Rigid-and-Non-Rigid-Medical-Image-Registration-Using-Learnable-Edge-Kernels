from arch.Reg_LEdge_U_Model_Variant_2 import ResUnet as ResNet
import glob
...
def main():
    ...
    weights = [1, 3]  # loss weights
    save_dir = 'NR_ID_2_2_ncc_{}_diffusion_{}/'.format(weights[0], weights[1])
    ...
    torch.save(model.state_dict(), 'experiments/NR_ID_2_2_ep500_sm3.pth.tar')
