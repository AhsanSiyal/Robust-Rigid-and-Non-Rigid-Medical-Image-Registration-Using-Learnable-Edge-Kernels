...
class ResUnet(nn.Module):
    def __init__(self, shape, channel, filters=[8, 16, 32, 32, 64]):
        ...
        self.laplace_layer1 = Laplacian3DConv(1)
    ...
    def forward(self, x):
        ...
        x_lap_0 = self.laplace_layer1(x_00)
        x_lap_1 = self.laplace_layer1(x_01)
