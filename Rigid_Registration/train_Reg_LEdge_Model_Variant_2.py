from arch.Reg_LEdge_Model_Variant_2 import ResUnet as resnet
import arch.Reg_LEdge_Model_Variant_2 as affine_net
...
def main():
    ...
    torch.save(model.state_dict(), 'experiments/ID2_ep500.pth.tar')
