from arch.Reg_LEdge_Model_Variant_1 import ResUnet as resnet
import arch.Reg_LEdge_Model_Variant_1 as affine_net
...
class Logger(object):
    def __init__(self, save_dir):
        ...
        self.log = open(save_dir+"logs.log", "a")
...
def main():
    ...
    torch.save(model.state_dict(), 'experiments/ID1_ep500.pth.tar')
